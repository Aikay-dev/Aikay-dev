...
export const projects: Project[] = [
  ...
  /* ---------------------------------------------------------------- BIDDY */
  {
    ...
    summary:
      "A consumer marketplace covering electronics, fashion, vehicles, real estate and food, where sellers list, buyers checkout through Paystack, and a seller tier system drives placement. I owned architecture, frontend, backend, infrastructure and production support across roughly 1,500 commits.",
    problem:
    ...
    outcomes: [
      ...
      "Containerised CI/CD from GitHub Actions to a self-managed VPS",
    ],
    stack: [
      "Next.js",
      "TypeScript",
